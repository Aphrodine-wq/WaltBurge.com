            ...
            >
                ...
                <motion.div variants={itemVariants} className="md:sticky md:top-32 text-center md:text-left">
                    ...
                    <div className="grid grid-cols-2 gap-4 mt-8 mx-auto md:mx-0 max-w-sm md:max-w-none">
                        <motion.div
                          ...
                          className="p-4 md:p-5 bg-brand-base/50 backdrop-blur-sm rounded-xl border border-brand-primary/5 transition-all group cursor-default"
                        >
                        ...
                        <motion.div
                          whileHover={{ scale: 1.05, borderColor: 'rgba(192, 132, 252, 0.3)' }}
                          className="p-4 md:p-5 bg-brand-base/50 backdrop-blur-sm rounded-xl border border-brand-primary/5 transition-all group cursor-default"
                        >
                ...
                <div className="space-y-12 flex flex-col items-center md:items-start">
                    ...
                    <motion.div
                      ...
                      className="glass-panel p-6 md:p-10 rounded-2xl border-l-4 border-l-brand-accent relative overflow-hidden group hover:shadow-2xl hover:shadow-brand-accent/5 transition-all duration-500 w-full"
                    >
